...
On a Mac, using Mac Ports, you should be able to install everything necessary with: 
sudo port install ffmpeg +lame +libogg +vorbis +faac +faad +xvid +x264 +a52 +gpl
